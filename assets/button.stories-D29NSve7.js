import{j as r}from"./index-GUXBK_0o.js";import{s as n,p as e,g as d,a as p}from"./theme-DHH34upk.js";/* empty css               */const o={gray:{text:e.common.black,background:e.primary.main,shadow:n.grayOutShadow,hover:{background:e.secondary.main,filter:d.orange,boxShadow:n.orangeOutShadow},active:{background:e.secondary.light,boxShadow:n.orangeInShadow}},green:{text:e.common.black,background:e.success.main,shadow:n.greenOutShadow,hover:{filter:d.green},active:{background:e.success.light,boxShadow:n.greenInShadow}},red:{text:e.common.black,background:e.error.main,shadow:n.redOutShadow,hover:{background:e.error.light,filter:d.red,boxShadow:n.redOutShadowHover},active:{background:e.error.lighter,boxShadow:n.redInShadow}}},t=({children:a,className:i,variant:x="gray",arrow:s=!1,...c})=>r.jsx(l,{className:i,...c,$variant:x,$arrow:s,children:a}),l=p.button`
  padding: 0px 12px;
  height: 36px;
  font-weight: 600;
